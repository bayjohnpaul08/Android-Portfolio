...
#### Technolgies : Android SDK, Java, Kotlin, XML, Okhttp, Retrofit, Android Jetpack, SQLite, Data Binding, Paging, Data Store, Kotlin Coroutines, Work Manager, Notifications
#### Design Pattern : Model-View-ViewModel (MVVM)
...
#### Technolgies : Android SDK, Java, Kotlin, XML, Okhttp, Retrofit, Android Jetpack, SQLite, Data Binding, Paging, Data Store, Kotlin Coroutines
#### Design Pattern : Model-View-ViewModel (MVVM)
